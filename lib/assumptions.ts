...
export const ASSUMPTION_DEFINITIONS: AssumptionDefinition[] = [
  ...
  },
  {
    ...
    label: 'Existing technology spend retired',
    description:
      'Only includes systems the prospect confirms can be eliminated or not renewed. This value is included once as recurring avoided cost and is not also subtracted from the investment denominator.',
    evidenceClass: 'direct',
    sourceKind: 'prospect',
